            ...
            <div class="col-lg-8 col-md-10 col-sm-12 col-sm-12">
                <div class="card card-outline rounded-0">
                        ...
                        <div class="container-fluid">
                           ...
                           <form action="" id="request-form">
                               ...
                               <div class="form-group col-lg-6 col-md-8 col-sm-12 col-xs-12">
                                   <label for="fullname" class="control-label">Имя <small class="text-danger">*</small></label>
                    ...
                    <div class="card-footer py-1 text-center">
                        <button class="btn btn-flat btn-sm btn-primary bg-gradient-primary" form="request-form"><i class="fa fa-paper-plane"></i> Подтвердить</button>
                        <button class="btn btn-flat btn-sm btn-light bg-gradient-light border" type="reset" form="request-form"><i class="fa fa-times"></i> Отмена</button>
                    </div>
                </div>
            </div>
        </div>
