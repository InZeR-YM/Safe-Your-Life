                        ...
                        <div class="row align-items-end">
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="date" class="control-label">Выбрать дату</label>
                                    <input type="date" class="form-control form-control-sm rounded-0" name="date" id="date" value="<?= $date ?>" required="required">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <button class="btn btn-sm btn-flat btn-primary bg-gradient-primary"><i class="fa fa-filter"></i> Фильтр</button>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <div class="card rounded-0 mb-2 shadow">
            <div class="card-header py-1">
                <div class="card-tools">
                    <button class="btn btn-flat btn-sm btn-light bg-gradient-light border" type="button" id="print"><i class="fa fa-print"></i> Печать</button>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="px-1 py-1 text-center">Код заказа</th>
                                <th class="px-1 py-1 text-center">Продукт</th>
                                <th class="px-1 py-1 text-center">Цена за единицу</th>
                                <th class="px-1 py-1 text-center">Количество</th>
                                <th class="px-1 py-1 text-center">Итого</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            <tr>
                                ...
                                <td class="px-1 py-1 align-middle text-right"><?= format_num($row['price'],2) ?> BYN</td>
                                <td class="px-1 py-1 align-middle text-right"><?= format_num($row['quantity'],0) ?> шт.</td>
                                <td class="px-1 py-1 align-middle text-right"><?= format_num($row['price'] * $row['quantity'],2) ?> BYN</td>
                            </tr>
                            <?php endwhile; ?>
                            <?php if($requests->num_rows <= 0): ?>
                                <tr>
                                    <td class="py-1 text-center" colspan="6">Записи не найдены</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                        <tfoot>
                            <tr>
                                <th colspan="5" class="text-center px-1 py-1 align-middle">Заработано</th>
                                <th class="text-right px-1 py-1 align-middle"><?= format_num($g_total,2) ?> BYN</th>
                            </tr>
                        </tfoot>
                    </table>
                </div>
        ...
        <div class="d-flex w-100 align-items-center">
            ...
            <div class="col-8">
                <div style="line-height:1em">
                    ...
                    <div class="text-center font-weight-bold h5 mb-0"><large>Отчёт ежедневных продаж</large></div>
