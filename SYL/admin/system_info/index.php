	...
	<div class="card card-outline rounded-0 card-danger">
		<div class="card-header">
			...
			<!-- <div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-navy new_department" href="javascript:void(0)"><i class="fa fa-plus"></i> Добавить новый</a>
			</div> -->
		</div>
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="name" class="control-label">Имя сайта</label>
					<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
				</div>
				<div class="form-group">
					<label for="short_name" class="control-label">Короткое имя сайта</label>
					<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>">
				</div>
			<div class="form-group">
				<label for="" class="control-label">Приветственный контент</label>
			...
			<div class="form-group">
				<label for="" class="control-label">О нас</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Логотип сайта</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Обложка сайта</label>
				<div class="custom-file">
			...
			<div class="form-group">
				<label for="" class="control-label">Фото баннера</label>
				<div class="custom-file">
	              ...
	              <label class="custom-file-label" for="customFile3">Выбрать файл</label>
	            </div>
				<small><i>Выбрать для загрузки новых фото к баннеру</i></small>
			</div>
			<?php 
...
<script>
	...
	function delete_img($path){
        ...
        $.ajax({
            ...
            error:err=>{
                console.log(err)
                alert_toast("Произошла ошибка при удалении фотографии","error");
                end_loader()
            },
	...
	$(document).ready(function(){
		$('.rem_img').click(function(){
            _conf("Вы уверены, что хотите удалить эту фотографию безвозвратно?",'delete_img',["'"+$(this).attr('data-path')+"'"])
        })
