...
<div class="card card-outline rounded-0 card-danger">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="./?page=categories/manage_category" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Создать новую</a>
		</div>
	</div>
	<div class="card-body">
							...
							<td align="center">
								 <button type="button" class="btn btn-flat p-1 btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="./?page=categories/view_category&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> Просмотреть</a>
				                    <div class="dropdown-divider"></div>
				                    <a class="dropdown-item" href="./?page=categories/manage_category&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Редактировать</a>
				                    <div class="dropdown-divider"></div>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Вы уверены, что хотите удалить эту категорию? Действие необратимо!","delete_category",[$(this).attr('data-id')])
		})
		$('.table').dataTable({
			columnDefs: [
