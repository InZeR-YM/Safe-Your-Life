...
<div class="content py-5 px-3 bg-gradient-danger">
	<h2><b><?= isset($id) ? "Изменить детали категории" : "Запись в новой категории" ?></b></h2>
</div>
	...
	<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
		<div class="card rounded-0">
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-primary btn-sm bg-gradient-primary btn-flat" form="category-form"><i class="fa fa-save"></i> Сохранить</button>
				<a class="btn btn-light btn-sm bg-gradient-light border btn-flat" href="./?page=categories"><i class="fa fa-times"></i> Отменить</a>
			</div>
		</div>
	</div>
</div>
