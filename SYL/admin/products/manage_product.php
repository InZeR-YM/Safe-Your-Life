...
<div class="content py-5 px-3 bg-gradient-danger">
	<h2><b><?= isset($id) ? "Обновление деталей товара" : "Новый товар" ?></b></h2>
</div>
	...
	<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
		<div class="card rounded-0">
				...
				<div class="container-fluid">
					<form action="" id="product-form">
						...
						<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label for="brand" class="control-label">Производитель</label>
						...
						<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label for="dose" class="control-label">Дозировка</label>
						...
						<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label for="price" class="control-label">Цена (BYN)</label>
						...
						<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<select name="status" id="status" class="form-control form-control-sm rounded-0" required="required">
								...
								<option value="0" <?= isset($status) && $status == 0 ? 'selected' : '' ?>>Отключён</option>
							</select>
						</div>
						<div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label for="status" class="control-label">Обложка</label>
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-primary btn-sm bg-gradient-primary btn-flat" form="product-form"><i class="fa fa-save"></i> Сохранить</button>
				<a class="btn btn-light btn-sm bg-gradient-light border btn-flat" href="./?page=products"><i class="fa fa-times"></i> Отмена</a>
			</div>
		</div>
	</div>
</div>
