				...
				<tbody>
					...
					?>
						<tr>
							...
							<td align="center">
                                <a class="btn btn-sm btn-flat btn-light bg-gradient-light border" href="./?page=inventory/view_inventory&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> Просмотр</a>
							</td>
						</tr>
					<?php endwhile; ?>
				</tbody>
