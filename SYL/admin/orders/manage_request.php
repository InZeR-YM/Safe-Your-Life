...
<div class="content py-5 px-3 bg-gradient-danger">
	<h2><b><?= isset($code) ? "Изменение <b>{$code}</b> деталей запроса" : "Новый запрос позиции" ?></b></h2>
</div>
	...
	<div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
		<div class="card rounded-0">
				...
				<div class="container-fluid">
					<form action="" id="request-form">
						...
						<div class="form-group">
							<label for="fullname" class="control-label">Название <small class="text-danger">*</small></label>
						...
						<div class="form-group">
							<label for="contact" class="control-label">Номер телефона <small class="text-danger">*</small></label>
						...
						<div class="form-group">
							<label for="message" class="control-label">Сообщение <small class="text-danger">*</small></label>
						...
						<div class="form-group">
							<label for="location" class="control-label">Местоположение <small class="text-danger">*</small></label>
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-primary btn-sm bg-gradient-primary btn-flat" form="request-form"><i class="fa fa-save"></i> Сохранить</button>
				<a class="btn btn-light btn-sm bg-gradient-light border btn-flat" href="./?page=requests"><i class="fa fa-angle-left"></i> Отмена</a>
			</div>
		</div>
	</div>
</div>
