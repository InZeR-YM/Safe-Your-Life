                    ...
                    <div class="card-body">
                        ...
                        ?>
                            <form action="" id="order-form">
                                ...
                                <h3><b>Итого: <?= format_num($cart_total,2) ?> BYN</b></h3>
                                <div class="form-group">
                                    <label for="delivery_address" class="control-label">Адрес доставки</label>
                                ...
                                <div class="py-1 text-center">
                                    <button class="btn btn-lg btn-deafault text-light bg-gradient-maroon col-lg-4 col-md-6 col-sm-12 col-xs-12 rounded-pill">Оформить заказ</button>
                                </div>
                            </form>
                        </div>
                    </div>
