                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                                            ...
                                            <div style="line-heigth:1em">
                                                ...
                                                <div class="text-muted d-flex w-100">
                                                    <div class="input-group input-group-sm rounded-0" style="width:10em!important">
                                                        ...
                                                        <input type="text" value="<?= $row['quantity'] ?> шт." class="form-control form-control-sm rounded-0 qty text-center" readonly="readonly">
                            ...
                            <?php if($cart->num_rows <= 0): ?>
                                <h5 class="text-center text-muted">Корзина пуста</h5>
                            <?php endif; ?>
                            ...
                            <div class="py-1 text-center">
                                <a href="./?p=checkout" class="btn btn-lg btn-deafault text-light bg-gradient-maroon col-lg-4 col-md-6 col-sm-12 col-xs-12 rounded-pill">Оформить заказ</a>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<script>
    ...
    $(function(){
        ...
        $('.del-item').click(function(){
            var item = $(this).closest('.cart-item')
            var id = item.attr('data-id')
            _conf("Вы уверены, что хотите удалить этот товар из корзины?", "delete_cart", [id])
        })
    })
