...
<div class="container-fluid">
    ...
    <?php if($order_items->num_rows <= 0): ?>
        <h5 class="text-center text-muted">В заказе нет товаров.</h5>
    <?php endif; ?>
...
<div class="py-1 text-right">
    <button class="btn btn-sm btn-light bg-gradient-light border btn-flat" type="button" data-dismiss="modal"><i class="fa fa-times"></i> Закрыть</button>
</div>