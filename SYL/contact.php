    ...
    <div class="row mt-lg-n4 mt-md-n4 justify-content-center">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="card rounded-0">
                <div class="card-body">
                    <h3 class="text-center"><b>Связаться с нами</b></h3>
                    <center><hr style="height:2px;width:5em;opacity:1" class="bg-danger"></center>
                    <dl>
                        <dt class="text-muted">Почта:</dt>
                        <dd class="pl-3"><?= $_settings->info('email') ?></dd>
                        <dt class="text-muted">Личная страница:</dt>
                        <dd class="pl-3"><?= $_settings->info('page') ?></dd>
                        <dt class="text-muted">Мобильный телефон:</dt>
