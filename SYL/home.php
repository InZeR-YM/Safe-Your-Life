                ...
                <div class="card card-outline rounded-0">
                    <div class="card-body">
                                ...
                                <a class="card rounded-0 shadow product-item text-decoration-none text-reset" href="./?p=products/view_product&id=<?= $row['id'] ?>">
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute bottom-1 right-1" style="bottom:.5em;right:.5em">
                                            <span class="badge badge-light bg-gradient-light border text-dark px-4 rounded-pill"><?= format_num($row['price'], 2) ?> BYN</span>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div style="line-height:1em">
                                            ...
                                            <div class="card-description w-100"><small class="text-muted">Количество: <?= format_num($row['available'],0) ?> шт</small></div>
                                        </div>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="text-center py-1">
                            <a href="./?p=products" class="btn btn-lg btn-deafault text-light bg-gradient-maroon col-lg-4 col-md-6 col-sm-12 col-xs-12 rounded-pill">Изучить другие продукты</a>
                        </div>
                    </div>
                </div>
            </div>
